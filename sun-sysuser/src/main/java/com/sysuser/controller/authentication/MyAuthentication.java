package com.sysuser.controller.authentication;
...
public class MyAuthentication {
	...
	public OAuth2AccessToken testAccessToken(HttpServletRequest request, HttpServletResponse response,@RequestBody SysUser userEntity) throws IOException {
